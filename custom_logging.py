...
class InterceptHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        log = logger.bind(request_id='main')
...
class CustomizeLogger:
    ...
    def make_logger(cls, config_path: Path):
        ...
        return cls.customize_logging(logging_config.get('path'), level=logging_config.get('level'),
                retention=logging_config.get('retention'), rotation=logging_config.get('rotation'),
